...
public class CarRepositoryImpl implements CarRepository {
    ...
    public void createCar(Car car) {
        ...
        template.update(sql, car.getBrand(), car.getModel(), car.getSteelPrice(), car.getTax(), car.getEmission(), car.getColor(), car.getLocation(), car.getDamageStatus(), car.getImage());
    }
